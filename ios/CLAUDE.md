...
| `GameReview.swift` (#62) | Post-game blunder analysis: replays a `GameRecord`, re-ranks every human ply at 3-ply, returns the moves that fell ≥10% short of the AI's best. On-device port of the CLI `review` command. See `REFERENCE.md`. |
